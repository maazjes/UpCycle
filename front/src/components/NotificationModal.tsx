...
const NotificationModal = (props: Props): JSX.Element => {
  ...
  const hideModal = (): { payload: undefined; type: 'notification/deleteNotification' } => dispatch(deleteNotification());
  ...
  return (
    ...
    >
      <View>
        <Text weight="bold" style={{ marginTop: 15, marginBottom: 10 }} size="subheading" align="center">Error</Text>
        <Text style={{ marginBottom: 15 }} align="center">{message}</Text>
        <Line />
