import { PayloadAction, createSlice, AnyAction, ThunkAction } from '@reduxjs/toolkit';
...
const setTimedNotification =
  (message: string, error: boolean): ThunkAction<void, RootState, undefined, AnyAction> =>
